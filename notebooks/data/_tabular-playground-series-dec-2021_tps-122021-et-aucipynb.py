...
model_et_AUC = tune_model(create_model('et'),optimize = 'AUC')
model_et_AUC 
...
plot_model(model_et_AUC,plot = 'confusion_matrix',use_train_data=True)


# In[ ]:


plot_model(model_et_AUC,plot = 'confusion_matrix')


# In[ ]:


plot_model(model_et_AUC,plot = 'class_report',use_train_data=True)


# In[ ]:


plot_model(model_et_AUC,plot = 'class_report')


# In[ ]:


predict_model(model_et_AUC)


# In[ ]:


final_et = finalize_model(model_et_AUC)
final_et
...
predictions=predict_model(final_et,data =test)
predictions.head()
