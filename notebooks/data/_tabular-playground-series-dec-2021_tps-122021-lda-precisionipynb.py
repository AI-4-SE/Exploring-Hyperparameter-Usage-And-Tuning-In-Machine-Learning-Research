...
model_lda_Precision = tune_model(create_model('lda'),optimize = 'Precision')
model_lda_Precision 
...
plot_model(model_lda_Precision,plot = 'confusion_matrix',use_train_data=True)


# In[ ]:


plot_model(model_lda_Precision,plot = 'confusion_matrix')


# In[ ]:


plot_model(model_lda_Precision,plot = 'class_report',use_train_data=True)


# In[ ]:


plot_model(model_lda_Precision,plot = 'class_report')


# In[ ]:


predict_model(model_lda_Precision)


# In[ ]:


final_lda = finalize_model(model_lda_Precision)
final_lda
