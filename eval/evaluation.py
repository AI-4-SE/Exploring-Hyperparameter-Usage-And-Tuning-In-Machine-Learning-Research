...
TEST_REPOS = [
    ...
    "https://github.com/natalialmg/MMPF", # IndexError can possibly be solved
    ...
    "https://github.com/guillermo-navas-palencia/optbinning", # IndexError can possible be solved
    ...
    "https://github.com/blue-yonder/tsfresh", # IndexError can possibly be sovled
    ...
    "https://github.com/classner/up", # IndexError can possibly be solved
    ...
    "https://github.com/noegroup/paper_boltzmann_generators", # IndexError can possibly be solved
    ...
    "https://github.com/umd-huang-lab/reinforcement-learning-via-spectral-methods", # IndexError can possibly be solved
